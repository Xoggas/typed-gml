...
internal static class CliCompilerRegistrations
{
    public static IReadOnlyList<ISemanticCheck> Checks() =>
    [
        new TypeAssignabilityCheck(), new PropertyInitializerCheck(), new NullabilityCheck(), new MemberAccessCheck(), new BaseCallCheck(),
        ...
        new StaticModifierCheck(), new StaticConstructorCheck(), new WithTargetCheck(),
        new SwitchCaseConstantCheck(), new DuplicateCaseCheck(), new VarInferenceCheck(),
        new ArrayLiteralTypeCheck(), new ThrowTypeCheck(), new TypeofNameCheck(), new IsAsCompatibilityCheck(),
        new DuplicateMemberCheck(), new DuplicateParameterCheck(), new DefaultParameterConstCheck(),
    ...
    public static IReadOnlyList<INodeEmitter> Emitters()
    {
        ...
        [
            ...
            new InvocationExpressionEmitter(), new IndexerAccessExpressionEmitter(),
            new ObjectCreationExpressionEmitter(), new LambdaExpressionEmitter(),
            new NullCoalescingExpressionEmitter(), new NullConditionalExpressionEmitter(),
            new ArrayLiteralExpressionEmitter(), new DictionaryLiteralExpressionEmitter(),
            new TypeofExpressionEmitter(), new NameofExpressionEmitter(), new DefaultExpressionEmitter(),
        ];
    }
}
